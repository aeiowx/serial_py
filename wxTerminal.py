...
class TerminalFrame(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        # Menu Bar Transmit
        wxglade_tmp_menu_transmit = wx.Menu()
        wxglade_tmp_menu_transmit.Append(ID_SEND, "&Send file", "", wx.ITEM_NORMAL)
        wxglade_tmp_menu_transmit.Append(ID_RECEIVE, "&Recieve file", "", wx.ITEM_NORMAL)
        self.frame_terminal_menubar.Append(wxglade_tmp_menu_transmit, "Transmit") 
        # Menu Bar Transmit end
    ...
    def __attach_events(self):
        ...
        self.Bind(wx.EVT_MENU, self.OnSendFile, id = ID_SEND)
        self.Bind(wx.EVT_MENU, self.OnReceiveFile, id = ID_RECEIVE)
    ...
    def OnSendFile(self, event):
        """Save contents of output window."""
        filename = None
        dlg = wx.FileDialog(None, "Open file..", ".", "", "Binary File|*.bin|All Files|*",  wx.OPEN)
        if dlg.ShowModal() ==  wx.ID_OK:
            filename = dlg.GetPath()
        dlg.Destroy()
    ...
    def OnReceiveFile(self, event):
        """Save contents of output window."""
        filename = None
        dlg = wx.FileDialog(None, "Save data as...", ".", "", "Text File|*.txt|All Files|*",  wx.SAVE)
        if dlg.ShowModal() ==  wx.ID_OK:
            filename = dlg.GetPath()
        dlg.Destroy()
